    ...
    return (
        <div>
            <Container className="xl:mt-13.75">
                <div className="bg-linear-to-b from-dark-pink/60 to-accent-dark-blue/80 rounded-[20px] xl:py-[76px] xl:px-[106px]">
                    <Heading className="text-center">Why Beyond Code</Heading>

                    <div className="mt-10 md:mt-12 lg:mt-16 xl:mt-20 flex flex-col md:flex-row items-center justify-between gap-10">
                        {beyondData.map((item, i) => (
                            <div
                                key={i}
                                className="w-full max-w-[380px] md:space-y-5"
                            >
